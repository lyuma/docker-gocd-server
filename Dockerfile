...
RUN \
  ...
  curl --fail --location --silent --show-error "https://download.gocd.org/experimental/binaries/20.7.0-12082/generic/go-server-20.7.0-12082.zip" > /tmp/go-server-20.7.0-12082.zip
RUN unzip /tmp/go-server-20.7.0-12082.zip -d /
...
LABEL gocd.version="20.7.0" \
  ...
  gocd.full.version="20.7.0-12082" \
  gocd.git.sha="20716e8231fbd31946e4b59fcf71a8e66a0191d4"
